...
def testB():
    ...
    #testing first_inside_quotes with the substring and its quotes being
    #the entire string
    print('Testing function first_inside_quotes')
    input = '"Hi Mom"'
    result = a1.first_inside_quotes(input)
    introcs.assert_equals('Hi Mom',result)
...
def testD():
    ...
    #empty test for is_currency
    print('Testing function is_currency')
    input = ''
    result = a1.is_currency(input)
    introcs.assert_equals(False, result)

    #incorrect test for is_currency with 3-letter code
    print('Testing function is_currency')
    input = 'USX'
    result = a1.is_currency(input)
    introcs.assert_equals(False, result)

    #incorrect test for is_currency with non-3-letter code
    print('Testing function is_currency')
    input = 'USDE'
    result = a1.is_currency(input)
    introcs.assert_equals(False, result)
